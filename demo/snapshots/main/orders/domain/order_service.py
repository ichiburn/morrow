...
This is the API the rest of the world uses. It orchestrates pricing,
promotions and inventory. Promotions are best-effort: if the cache is
unavailable the order still quotes and places, just without a discount.
"""
